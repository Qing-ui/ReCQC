...
class CHResultViewer:
    ...
    def show_detail(self, mol_id):
        ...
        # 下部表格区域
        table_frame = tk.LabelFrame(main_frame, text="Matching points details", bg='#2C3E50', fg='white', height=350)
        table_frame.pack(fill=tk.BOTH, expand=True, padx=10, pady=5)
        table_frame.pack_propagate(False)

        # 创建表格
        columns = ("Type", "C Displacement (Library)", "H Displacement (Library)", "C Displacement (User)", "H Displacement (User)", "Distance", "Score")
