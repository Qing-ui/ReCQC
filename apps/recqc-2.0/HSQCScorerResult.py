...
class CHResultViewer:
    ...
    def create_result_item(self, result, rank):
        ...
        ttk.Label(info_frame, text=f"Matching points: {matched}/{total}").pack(anchor=tk.W)
    ...
    def show_detail(self, mol_id):
        ...
        tk.Label(
            header_frame,
            text=f"ID: {mol_id} | Name: {mol_name} | Score: {float(score_data[0]):.2f} | Matching points: {score_data[1]}/{score_data[2]}",
            bg="#2C3E50",
            fg="white",
            font=("Arial", 12),
        ).pack(side=tk.LEFT)
        ...
        table_frame = tk.LabelFrame(
            main_frame, text="Matching points details", bg="#2C3E50", fg="white", height=350
        )
